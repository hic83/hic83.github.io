...
녹색 테두리▼★은 함락 후 발생하는 H 장면 이벤트. 3개씩 본 후 개인별 End 분기(보라색 FINAL)가 출현한다.
End 중 하나를 보지않은 채로 60일이 지나면 Bad End가 된다.  
...
* **Load#11**
* 53일째 점심 시간 - 쿠라사와 아야나 - ◇★GH1 - 最後の破瓜(쿠라사와 아야나 End)
* **Load#12**
* 53일째 방과후 - 쿠라사와 아야나 - ◇★GH2 - 闇を孕んだ肉人形(쿠라사와 아야나 임신 End)

### 토우조 마히로
* **Load#12**
* 53일째 방과후 - 토우조 마히로 - ◇★GH1 - マゾ牝の嬌声(토우조 마히로 End)
* **Load#10 **
* 53일째 수업 시간 - 토우조 마히로 - ◇★GH2 - 噴き散らす孕み豚(토우조 마히로 임신 End)

### 니토우 토모에
* **Load#12**
* 53일째 방과후 - 니토우 토모에 - ◇★GH1 - 官能支配(니토우 토모에 End)
* **Load#11**
* 3일째 점심 시간 - 니토우 토모에 - ◇★GH2 - 壊れた心, 膨れた腹(니토우 토모에 임신 End)

### 타카자키 아이카
* **Load#12**
* 53일째 방과후 - 타카자키 아이카 - ◇★GH - 征服された肉穴と心(타카자키 아이카 End)
* **Load#11**
* 53일째 점심 시간 - 타카자키 아이카 - ◇★GH2 - 愛玩妊婦奴隷(타카자키 아이카 임신 End)

### 마츠우라 안주
* **Load#11**
* 53일째 점심 시간 -  마츠우라 안주 - ◇★GH1 - ご主人様の命じるままに(마츠우라 안주 End)
* **Load#10**
* 53일째 수업 시간 - 마츠우라 안주 - ◇★GH2 - 孕み腹は隷属の証(마츠우라 안주 임신 End)
