...
* ...아직 기다려 본다.
* 어젯밤의 뒷골목으로 서둘러 가자.
* **Save**<br> 쓸데없는 일이 되더라도 알퀘이드를 찾아야만 한다. => True End
* **Load**<br> 약속을 지킨다. => True End<br> 알퀘이드를 잊을 수 없다. => Good End
...
* 앞으로 도망친다.
* 취향대로
* 알퀘이드는 따를 수 없다. => True End<br> 알퀘이드를 따른다. => Good End
...
* ...아키하를 쫓아간다.
* ...그것만은, 할 수 없다.
* ...아키하한테, 이 생명을 돌려 준다. => True End<br> ...그렇게는, 할 수 없다. => Normal End
...
* 히스이한테 부탁해 본다.
* ...이런 걸로는 전혀 충분하지 않다.
* **Save**<br> ...어째서 문을 잠가 놓았지? => True End
* **Load**<br> ...어째서 문을 잠가 놓았지?<br> 코하쿠의 이름을 외친다. => Good End
